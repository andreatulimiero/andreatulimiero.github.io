...
b.classList.add("selected");if(b.classList.contains("home"))c.style.transform="translateX(0)";else{var e=b.offsetWidth/c.offsetWidth;c.style.transformOrigin="left";c.style.transform="translateX("+(b.offsetLeft-d)+"px) scaleX("+e+")";b.classList.contains("ethos")||b.classList.contains("projects")}};a.querySelectorAll("span").forEach(function(a){a.addEventListener("click",function(a){menu.selectArticle(a.target)})})}
...
function initArticles(){initHome();initprojects();var b={isHanging:!1,intervalId:void 0,waitTime:100,hang:function(){mThis=this;mThis.isHanging=!0;mThis.intervalId=setInterval(function(){mThis.isHanging=!1},mThis.waitTime)}};window.addEventListener("scroll",function(a){pageIsScrolling||b.isHanging||(b.hang(),a=Math.round(window.scrollY),a>=document.querySelector("article.projects").offsetTop-menu.height?menu.highlightTitle(document.querySelector(".titles .projects")):a>=document.querySelector("article.ethos").offsetTop-
